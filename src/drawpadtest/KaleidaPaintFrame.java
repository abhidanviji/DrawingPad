...
import drawpad.KeyboardDrawingCanvas;
    ...
    public class KaleidaPaintFrame extends Frame {
       ...
       public KaleidaPaintFrame() {
          ...
          choice4.add("Serif");
          choice4.add("Sans-Serif");
          choice4.add("Monospaced");
          choice4.add("Dialog");
          choice4.add("DialogInput");
    ...
    class KaleidaFrameCanvas extends Canvas 
       ...
       private String getFontFamily(){
    	   int fontCh = fontChoice.getSelectedIndex();
    	   switch (fontCh) {
           case SERIF:
              return "Serif";
           case SANSSERIF:
       ...
       private void putText(){
    	   KeyboardDrawingCanvas keyboardDrawingCanvas = new KeyboardDrawingCanvas();
